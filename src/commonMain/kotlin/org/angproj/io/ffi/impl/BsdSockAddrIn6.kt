...
import org.angproj.io.ffi.type.BsdSockAddrIn6T

/*public class BsdSockAddrIn6 internal constructor(
    bin: Binary, offset: Int, layout: NativeLayout<BsdSockAddrIn6>
) : SockAddrIn6(bin, offset, layout), BsdSockAddrIn6T {
    ...
    public companion object : NativeLayout<BsdSockAddrIn6>() {
        override val layout: Array<TypeSize> = arrayOf(
            TypeSize.U_BYTE, TypeSize.U_BYTE, TypeSize.U_SHORT, TypeSize.U_INT, TypeSize.LONG
        )

        override fun create(
            bin: Binary, index: Int, layout: NativeLayout<BsdSockAddrIn6>
        ): BsdSockAddrIn6 = BsdSockAddrIn6(bin, index, layout)
    }
}*/
